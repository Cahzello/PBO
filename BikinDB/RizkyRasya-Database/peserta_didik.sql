...
(1, 'Ganisa', '0000-00-00', 'Jl Sukma Jadi', 'Laki Laki'),
(2, 'Hikaru', '0000-00-00', 'Jl Jadi Jadi', 'Laki Laki'),
(3, 'Yazid', '0000-00-00', 'Jl Chad', 'Laki Laki');
...
--
ALTER TABLE `profil`
  MODIFY `nisn` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
